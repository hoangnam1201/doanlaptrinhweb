        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-3">
                ...
                <ul class="footer-links">
                    <li><a href="http://scanfcode.com/category/c-language/">Javascrpit</a></li>
                    <li><a href="http://scanfcode.com/category/front-end-development/">UI Design</a></li>
                    <li><a href="http://scanfcode.com/category/back-end-development/">PHP</a></li>
                    <li><a href="http://scanfcode.com/category/java-programming-language/">Java</a></li>
                    <li><a href="http://scanfcode.com/category/android/">Angular</a></li>
                    <li><a href="http://scanfcode.com/category/templates/">ReactJS</a></li>
                </ul>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6 col-sm-12">
                <ul class="social-icons">
                    ...
                    <li><a class="linkedin" href="#"><i class="fab fa-youtube-square"></i></a></li>
                </ul>
            </div>
        </div>
    </div>
